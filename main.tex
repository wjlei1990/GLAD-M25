...
arrivals in 4 of the body wave measurement categories. All the
categories show consistent reduction in both mean and variance values. 
Even though there are many kinds of phases assimilated  and
...
\begin{figure}
  ...
  \caption{Histograms of phase measurements of P arrivals in four measurement categories for S362ANI combined with CRUST2.0 (M00, \textbf{Black}), GLAD-M15 (M15, \textbf{{\color{ForestGreen} Green}}) and GLAD-M25 (M25, \textbf{{\color{Red} Red}}). Other settings are the same as Fig.~\ref{fig:phase_hist}. }
