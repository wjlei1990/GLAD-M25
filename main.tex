...
\begin{figure}
  ...
  \caption{Histograms of 17--40~s traveltime anomalies of P arrival(Vertical and Radial), and SH arrival(Transverse) for models S362ANI combined with CRUST2.0 (M00, Black), GLAD-M15 (M15, Green), and GLAD-M25 (M25, Red).
  }
...
\begin{figure}
  ...
  \caption{Same as Fig.~\ref{fig:PS_phase_hist}, except for the held-out database.}
