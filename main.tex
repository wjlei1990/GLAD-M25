...
\begin{figure}
  \centering
  \includegraphics[width=0.75\textwidth]{figures/psf/yellowstone.pdf}
  \caption{\small{ PSF of Yellowstone. }}
  \label{fig:psf_yellowstone}
\end{figure}

\begin{figure}
  \centering
  \includegraphics[width=0.75\textwidth]{figures/psf/easter.pdf}
  \caption{\small{ PSF of Easter. }}
  \label{fig:psf_easter}
\end{figure}

\begin{figure}
  \centering
  \includegraphics[width=0.75\textwidth]{figures/psf/afar.pdf}
  \caption{\small{ PSF of Afar. }}
  \label{fig:psf_afar}
\end{figure}

\begin{figure}
  \centering
  \includegraphics[width=0.75\textwidth]{figures/psf/su.pdf}
  \caption{\small{ PSF of Su. }}
  \label{fig:psf_su}
\end{figure}
