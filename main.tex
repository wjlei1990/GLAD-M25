...
Tesla K20X GPUs takes approximately 10~min of wall clock time. {\color{red} Wenjie: is that correct?}
...
In this paper we focus predominantly on isotropic shear and compressional wavespeed variations.
...
and in Fig.~\ref{fig:powerspectraradius} we plot the normalized power per degree as a function of radius
