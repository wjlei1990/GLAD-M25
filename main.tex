...
For comparison,
we again include the two global models S362ANI$+$M and S40RTS,
as well as regional model EU60~\citep{zhu2015seismic},
which is based on adjoint tomography.
Again there is good agreemment with the two global models with regards to the longer wavelength structure,
although the Iceland hotspot is less prominent in S362ANI$+$M.
In the 100--200~km depth range we see the Massif Central, the Eiffel hotspot,
and the Central Slovakia Volcanic Field as distinctly slow anomalies,
in agreement with EU60.
In the 400--600~km depth range,
GLAD-M25 is again in good agreement with~EU60,
featuring past subduction in the Mediterranean,
including the present-day Aegean slab.
