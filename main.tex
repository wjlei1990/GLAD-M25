...
\begin{figure}
  ...
  The maximum window count is 7,542 in the 86--87$^\circ$ distance and 1,378--1,379~sec time bin.
   }
...
\begin{figure}
  ...
  \caption{Same as Fig.~\ref{fig:window_density_Z}, except for transverse component 17--40~s body waves.
   ...
   The maximum window count is 7,208 in the 89--90$^\circ$ distance and 1,398--1,399~sec time bin.
...
\begin{figure}
  ...
  \caption{Histograms of 17--40~s P-wave traveltime anomalies of the vertical and radial components for models S362ANI combined with CRUST2.0 (M00, Black), GLAD-M15 (M15, Green), and GLAD-M25 (M25, Red).
  }
...
\begin{figure}
  ...
  \caption{Same as Fig.~\ref{fig:phase_hist}, except for the held-out database.
  }
...
\begin{figure}
  ...
  \caption{Same as Fig.~\ref{fig:P_phase_hist}, except for the held-out database.}
...
we may calculate the model norm in the GLL basis,
\begin{equation}
