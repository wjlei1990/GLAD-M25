...
separating the  Precambrian East European Craton~(EEC) in the Northeast from Phanerozoic Europe in the Southwest.
The TESZ is very consistent across all models,
even though is much sharper in GLAD-M25 and EU60.

At depths of 100---250~km we observe high wavespeeds beneath the Central Graben in the North Sea, which is clearly separated from the EEC.
...
We see slab ponding in the transition zone beneath the western Mediterranean associated with slab roll-back of the Appennines-Maghrebides subduction zone~\citep{Giordano2017Magmatic}.
At shallower depths, we see low wavespeeds along its western border,
which are interpreted as back-arc extension associated with the roll-back. Compared to S362ANI$+$M and S40RTS,
...
Its southern part interacts with the Hellenic slab, which penetrates the mantle transition zone and extends below 1,000~km in our model.
...
In Central Europe we note the Cenozoic Ridge System, characterized by low  wavespeeds from the Massif Central to the Eifel. Both EU60 and
GLAD-M25 exhibit a slow anomaly beneath the northern part of the Rhine Graben, which is interpreted as the reservoir that fuels the Eifel hotspot.

Beneath the Atlantic Ocean, our model strengthens slow anomalies beneath the ridges, especially underneath Iceland and the Azores.
Compared to S362ANI$+$M, Iceland becomes
much stronger in the upper mantle at depths from 250~km to 400~km, extending all the way to the mantle-transition zone.
...
\begin{figure}[h]
    ...
    \caption{Vertical cross sections of perturbations of shear wave velocity Vs of plumes.}
\end{figure}
...
\begin{figure}[h]
    \centering
    \sidesubfloat[]{\includegraphics[width=0.98\textwidth]{figures/subductions/Aeg.png}\label{fig:a}}\\[-4pt]
    \sidesubfloat[]{\includegraphics[width=0.98\textwidth]{figures/subductions/Br.png}\label{fig:b}}\\[-4pt]
    \sidesubfloat[]{\includegraphics[width=0.98\textwidth]{figures/subductions/Ha.png}\label{fig:c}}\\[-4pt]
    \sidesubfloat[]{\includegraphics[width=0.98\textwidth]{figures/subductions/Ne.png}\label{fig:d}}\\[-4pt]
    \sidesubfloat[]{\includegraphics[width=0.98\textwidth]{figures/subductions/Wc.png}\label{fig:a}}\\[-4pt]
    \caption{Vertical cross sections of perturbations of shear wave velocity Vs of plumes.}
\end{figure}
