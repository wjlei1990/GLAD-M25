...
the Antarctic Seismographic Argentinean Italian Network~(AI), the New Zealand National Seismograph Network~(NZ), and the F-net broadband seismograph network by NIED, constitute a significant part
...
Depending on the time window length and wave period range, we use a multi-taper technique \citep[e.g.,][]{laske_constraints_1996} to make frequency-dependent phase measurement when possible and adopt a cross-correlation measurement \citep[e.g.,][]{luo_wave-equation_1991} for the rest of data.
...
%\cyan{How were source corrections applied to GLAD-M15 and S362ANI+Crust2.0? Did you apply the correction terms computed for GLAD-M25 to all models?} I believe so.
...
%\cyan{but the models were not expanded to spherics harmonics to plot in this paper, right?}. No.
...
%\cyan{do you know why the African plume tilts? I think Pacific plume tilts likely because of the plate motion. GLAD-M25 generally shows that this tilt is happening widely in the upper mantle and perhaps the top of the lower mantle. But the African plume's tilt start from the CMB}  No. It's in the Texas model too.
...
% In the contour plot of positive shear-wavespeed perturbations we observe three gaps, which may correspond to ridges or volcanic plateaus on the subducted Nazca plate, and indicate a weakened or even torn slab \citep[e.g.,][]{Hu2016} 
%\cyan{I think it is a great story but would you like to put the contour plot here or reserve for the future paper?}. OK.
...
%Relatively smoother slabs in GLAD-M25 are likely related to our choice of smoothing considering the minimum period of body waves in our simulations, $\sim17$~s, which is longer than typical teleseismic body-wave tomography studies.
