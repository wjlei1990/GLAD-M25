...
The simulations were performed on the Cray XK7 ``Titan'' and the IBM ``Summit'' at the Oak Ridge Leadership Computing Facility.
...
We compare GLAD-M25 with several other global and regional models,
...
SPECFEM3D\_GLOBE~\citep{KoTr02a,KoTr02b} on the Cray supercomputer ``Titan'' and the IBM ``Summitt'' at the Oak Ridge Leadership Computing Facility (OLCF) for global adjoint tomography.
...
Accommodating inevitable hardware failures during this process is critical
to prevent contamination of the inversion results.
For these reasons, we are in the process of using EnTK as our
...
\begin{figure}
  ...
  \caption{\small{1D radial-anisotropic shear and compressional wavespeed profiles for GLAD-M25 and STW105. The reference frequency for physical dispersion is 1~Hz.}}
